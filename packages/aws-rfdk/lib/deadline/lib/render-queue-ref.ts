...
export interface RenderQueueSizeConstraints {
   ...
   *
   * Deadline versions earlier than 10.1.10 do not support being horizontally scaled behind a load-balancer.
   * For these versions of Deadline, the desired number of processes can only be set to 1, otherwise an error is thrown.
   *
   ...
   *
   * The minimum that this can value be set to is 1.
   * This value can not be less than min or desired
   *
   * @default 1
   */
  readonly max?: number;
